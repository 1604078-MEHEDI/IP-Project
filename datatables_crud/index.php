		...
		<div class="row">
			<div class="col-md-12">
				...
				<button class="btn btn-default pull pull-right" data-toggle="modal" data-target="#addMember" id="addMemberModalBtn">
					<span class="glyphicon glyphicon-plus-sign"></span> Add Restaurant
				</button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span> Add Restaurant</h4>
				</div>

				<form enctype="multipart/form-data" class="form-horizontal" action="php_action/create.php" method="POST" id="createMemberForm">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="contact" class="col-sm-2 control-label">Images</label>
							<div class="col-sm-10">
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="removeMemberModal">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title"><span class="glyphicon glyphicon-trash"></span> Remove Reataurant</h4>
				</div>
				<div class="modal-body">
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="editMemberModal">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title"><span class="glyphicon glyphicon-edit"></span> Edit Restaurant</h4>
				</div>
				...
				<form class="form-horizontal" action="php_action/update.php" method="POST" id="updateMemberForm">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="editActive" class="col-sm-2 control-label">Division</label>
							<div class="col-sm-10">
